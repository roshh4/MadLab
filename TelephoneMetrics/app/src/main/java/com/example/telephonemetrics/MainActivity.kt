package com.example.telephonemetrics
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btGetTelSer.setOnClickListener {
            ...
            val phoneType= when(telephonyManager.networkOperatorName) {
                TelephonyManager.PHONE_TYPE_CDMA.toString() -> "CDMA"
                TelephonyManager.PHONE_TYPE_GSM.toString() -> "Ready"
                else -> "Others"
            }
            ...
            val networkType = when(telephonyManager.networkType){
                TelephonyManager.NETWORK_TYPE_LTE -> "48"
